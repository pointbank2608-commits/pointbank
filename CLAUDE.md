...
- `/curriculum` (네비 라벨 "내 커리큘럼") — 캔바식 슬라이드 빌더(`LessonSlideSorter.tsx`, 이미지·유튜브·게임·수업 자료실). **준비는 편집 화면에서 끝내고, "발표하기" 뒤엔 수업만 한다(2026-09-25 사용자 결정).**

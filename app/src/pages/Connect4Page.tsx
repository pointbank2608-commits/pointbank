...
function defaultItems(): GameItem[] {
  return [1, 2, 3, 4, 5, 6, 7].map((n) => ({ id: uid(), label: i18n.t('gameConnect4.defaultItem', { n }) }));
}

export default function Connect4Page() {
  const { t } = useTranslation();
  const g = useGameTemplates({ gameType: 'connect4', defaultItems });
  const {
    isStaff,
    classes,
    staffClassId,
  ...
  async function clearAllItems() {
    ...
    if (!confirm(t('gameConnect4.clearAllConfirm'))) return;
    await persistItems([]);
  }
  ...
  const classPicker = isStaff ? (
    ...
    <h2 className="font-title-md text-title-md text-on-surface">
      {t('gameConnect4.studentClassTitle', { className: studentClassName })}
    </h2>
  );
    ...
    <div className="bg-surface-container-lowest rounded-xl p-5 shadow-[0_4px_20px_rgba(39,101,168,0.08)] space-y-4">
      <div>
        ...
        <input
          ...
          placeholder={t('gameConnect4.namePlaceholder')}
          onKeyDown={(e) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <GameInfoPanel
        ...
        steps={t('gameConnect4.infoSteps', { returnObjects: true }) as string[]}
      />
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <div className="text-center py-16 bg-[#fffdf8] rounded-[28px] shadow-[0_8px_28px_rgba(0,107,93,0.08)]">
            <img src="/skins/c4-board.png" alt="" className="mx-auto mb-3 h-16 w-auto" />
        ...
        <div className="space-y-6">
          ...
          >
            <Connect4 key={roundKey} ref={gameRef} items={selected.items} />
          </GameThemeFrame>
            ...
            {isStaff && (
              <div className="bg-surface-container-lowest rounded-xl p-5 shadow-[0_4px_20px_rgba(39,101,168,0.08)]">
                <div className="flex items-center justify-between mb-2">
                  <h4 className="font-title-md text-title-md text-on-surface">{t('gameConnect4.settingsTitle')}</h4>
                ...
                {editorOpen && (
                  <div>
                    <OpenInOtherGame currentType="connect4" itemCount={selected.items.length} onOpen={openInOtherGame} />

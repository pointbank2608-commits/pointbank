...
const SUMMARY = [
  ...
  { emoji: '🎡', title: '미니게임', desc: '돌림판 · 사다리 · 공 뽑기 · 시한폭탄 · 타이머' },
...
export default function LandingPage() {
  return (
    <div className="landing">
      ...
      <section className="landing-hero-band">
        <div className="landing-hero">
          ...
          <div className="landing-beta-note">
            지금은 베타 기간이라 완전 무료로 이용하실 수 있어요.
          </div>
        </div>
      </section>

      {/* 한눈에 보기 */}
      <section className="landing-band band-white">
        <div className="landing-inner">
          <h2 className="landing-band-title">클래스뱅크 하나로 이만큼</h2>
          <div className="landing-summary">
            {SUMMARY.map((s) => (
              <div className="landing-summary-card" key={s.title}>
                <div className="landing-summary-emoji">{s.emoji}</div>
                <div className="landing-summary-title">{s.title}</div>
                <div className="landing-summary-desc">{s.desc}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* 기능 1 — 포인트 뱅킹 */}
      <section className="landing-band band-blue">
        <div className="landing-inner landing-feature">
          <div className="landing-frame frame-lavender">
            <div className="landing-frame-stage">
              <div className="passbook" style={{ maxWidth: 250 }}>
                ...
                <div className="preset-row" style={{ paddingBottom: 14 }}>
            ...
            <div className="landing-frame-caption">
              사유 버튼 하나로 바로 지급 · 차감
              <br />
              <strong>누적 대신 오늘 적립만</strong> 크게 보여줘요
            </div>
          </div>
      ...
      {/* 기능 2 — 돌림판 */}
      <section className="landing-band band-pink">
        <div className="landing-inner landing-feature reverse">
          <div className="landing-frame frame-pink">
            <div className="landing-frame-stage">
              <div className="landing-wheel-scale">
                <SpinWheel items={WHEEL_ITEMS} />
              </div>
            </div>
            <div className="landing-frame-caption">
              항목을 등록하고 <strong>직접 돌려보세요</strong>
              <br />
              반 전용 · 학원 공용 모두 만들 수 있어요
            </div>
          </div>

          <div className="landing-feature-text">
            <div className="landing-feature-eyebrow">미니게임 · 돌림판 · 사다리 · 랜덤 공 뽑기</div>
            <h2>
              발표자 뽑기,
              <br />
              이제 게임으로 한 번에
      ...
      {/* 기능 3 — 출석부 */}
      <section className="landing-band band-mint">
        <div className="landing-inner landing-feature">
          <div className="landing-frame frame-mint">
            <div className="landing-frame-stage">
              <div className="att-grid-wrap" style={{ maxWidth: 300, boxShadow: 'none' }}>
            ...
            <div className="landing-frame-caption">
              반별 · 월별 <strong>학생 × 날짜 표</strong>로 한눈에
              <br />
              빠뜨린 날짜는 눌러서 바로 채워 넣어요
            </div>
          </div>

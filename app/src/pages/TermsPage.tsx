          ...
          <section>
            ...
            <ol className="list-decimal space-y-1.5 pl-5">
              <li>
                ...
                기능과 게임 센터 중 일부(돌림판, 사다리, 시한폭탄, 행맨)만 이용할 수 있습니다.
              </li>
              <li>
                <span className="font-bold">유료 플랜</span> — 반·학생 수 제한 없이 전체 기능(단어 사전, 파닉스, 내
                단어장, 게임 센터 전체, 리포트 등)을 이용할 수 있습니다. 등록 학생 수가 10명을 초과하는 경우, 초과 인원

    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <div>
            <GameThemeFrame gameType="matchup" roster={roster} className="bg-[#fffdf8] rounded-[28px] p-4 md:p-6 shadow-[0_8px_28px_rgba(0,107,93,0.08)]">
        ...
        <div className="space-y-6">
          ...
          <GameThemeFrame gameType="matchup"
            roster={roster}

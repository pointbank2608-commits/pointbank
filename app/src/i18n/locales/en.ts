...
const en: Ko = {
  ...
  gameSaveOrGive: {
    ...
    infoDescription:
      'Open the box to reveal an English word. After reading it, choose whether you keep the points or give them away. Once an item is used it won\'t come up again.',
    infoSteps: [
      'In settings, choose Play individually (student roster) or Play in teams (team count), and register the words to put in the box.',
      'Tap the box to open it — a board with a word pops out.',
      'Once the word is read, choose Save it (keep) or Give it (hand to someone else). With 3+ participants, a screen lets you pick exactly who.',
      "A random point effect is applied, and everyone's running score stays on screen. Used items won't repeat — once they're all gone, restart from scratch.",
    ],
  },
